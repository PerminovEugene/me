...
export const metadata: Metadata = {
  ...
  description:
    "Read articles on Solidity gas optimization, web development best practices, and other tech topics by Evgenii Perminov, a senior software engineer.",
  keywords: [
    ...(metadataBase.keywords as string[]),
    "tech articles",
    "blockchain articles",
    "solidity tutorials",
    "gas optimization",
  ...
  openGraph: {
    ...
    title: "Articles by Evgenii Perminov | Tech, Blockchain & Web Development",
    description:
      "Read articles on Solidity gas optimization, web development best practices, and other tech topics by Evgenii Perminov.",
